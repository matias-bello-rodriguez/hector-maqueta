...
const CalendarioModule = () => {
  ...
  const [eventos, setEventos] = useState([
    { id: 1, fecha: '2025-11-25', titulo: 'Matrimonio González', hora: '19:00', tipo: 'matrimonio', lugar: 'Salón Los Arrayanes', personas: 150, cliente: 'María González', notas: 'Menú gourmet confirmado' },
    { id: 2, fecha: '2025-11-28', titulo: 'Evento TechCorp', hora: '18:30', tipo: 'corporativo', lugar: 'Hotel Grand Marina', personas: 80, cliente: 'TechCorp S.A.', notas: 'Requiere setup audiovisual' },
    { id: 3, fecha: '2025-12-02', titulo: 'Cumpleaños Ramírez', hora: '20:00', tipo: 'cumpleaños', lugar: 'Restaurant El Mirador', personas: 50, cliente: 'Carlos Ramírez', notas: 'Pastel personalizado' },
    { id: 4, fecha: '2025-12-05', titulo: 'Aniversario Martínez', hora: '19:30', tipo: 'aniversario', lugar: 'Casa Particular', personas: 30, cliente: 'Ana Martínez', notas: 'Decoración romántica' },
    { id: 5, fecha: '2025-12-15', titulo: 'Cena Navidad Empresa', hora: '20:00', tipo: 'corporativo', lugar: 'Centro de Eventos', personas: 120, cliente: 'Empresa XYZ', notas: 'Temática navideña' },
    { id: 6, fecha: '2025-11-25', titulo: 'Brunch Empresarial', hora: '11:00', tipo: 'corporativo', lugar: 'Hotel Plaza', personas: 40, cliente: 'StartupLab', notas: 'Menú vegetariano disponible' },
    { id: 7, fecha: '2025-12-20', titulo: 'Boda Silva-Pérez', hora: '18:00', tipo: 'matrimonio', lugar: 'Hacienda El Roble', personas: 200, cliente: 'Andrea Silva', notas: 'Ceremonia al aire libre' },
  ]);
                  ...
                  <div className="space-y-0.5 overflow-y-auto max-h-16">
                    {eventosDelDia.slice(0, 3).map((evento) => (
                      <div
                        ...
                        className={`text-[10px] text-white px-1 py-0.5 rounded ${tipoColors[evento.tipo].bg} truncate hover:opacity-80 transition-opacity cursor-pointer`}
                ...
                eventosProximos.map((evento) => {
                  ...
                  return (
                    <div 
                      key={evento.id} 
                      onClick={() => setEventoSeleccionado(evento)}
                      className={`border-l-4 ${tipoColors[evento.tipo].border} ${tipoColors[evento.tipo].light} p-4 rounded-r-lg hover:shadow-md transition-all cursor-pointer ${
                        esUrgente ? 'ring-2 ring-red-300' : ''
                      }`}
                    >
                      <div className="flex items-start justify-between mb-2">
                        <h4 className="font-semibold text-slate-800 flex-1">{evento.titulo}</h4>
                        <span className={`text-white text-xs px-2 py-1 rounded ${tipoColors[evento.tipo].bg}`}>
                          {evento.tipo}
                        </span>
                      </div>
      ...
      {eventoSeleccionado && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className={`${tipoColors[eventoSeleccionado.tipo].bg} text-white p-6 rounded-t-xl`}>
            ...
            <div className="p-6 space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 p-4 rounded-lg">
                  ...
                  <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${tipoColors[eventoSeleccionado.tipo].bg} text-white`}>
